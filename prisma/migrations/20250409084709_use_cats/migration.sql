...
INSERT INTO "new_auth_user" ("about", "email", "id", "ingExtra", "ingMatch", "ingOriginal", "ingSymbol", "isAdmin", "isRoot", "language", "name", "publicProfile", "publicRecipes", "skipSmallUnits", "theme", "units", "username") SELECT "about", "email", "id", "ingExtra", "ingMatch", "ingOriginal", "ingSymbol", "isAdmin", "isRoot", "language", "name", "publicProfile", "publicRecipes", "skipSmallUnits", "theme", "units", "username" FROM "auth_user";
