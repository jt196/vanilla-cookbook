...
<script>
	...
	let {
		...
		oidcEnabled = false,
		oidcName = 'OIDC',
		providers = null, // { google: true, github: true, oidc: true }
		label = '',
	...
	$effect(() => {
		if (providers) {
			...
			oidcEnabled = !!providers.oidc
		}
	})
</script>

{#if googleEnabled || githubEnabled || oidcEnabled}
			...
			{#if oidcEnabled}
				...
				>
					...
					<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
						<path
							d="M12 2C9.24 2 7 4.24 7 7c0 1.94 1.1 3.63 2.73 4.47L7 22h2l1-4h4l1 4h2l-2.73-10.53C16.9 10.63 18 8.94 18 7c0-2.76-2.24-5-5-5zm0 2c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3z"
						/>
					</svg>
