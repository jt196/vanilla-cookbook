<script>
	...
	let { state = 'empty', height = '15px', fill = 'oklch(var(--p))' } = $props()
</script>
...
{:else if state === 'half'}
	...
	<svg xmlns="http://www.w3.org/2000/svg" {height} fill="currentColor" viewBox="0 0 640 512"
		><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path
...
{:else}
	<!-- SVG for fully filled star -->
	<svg xmlns="http://www.w3.org/2000/svg" {height} fill="currentColor" viewBox="0 0 576 512"
		><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path
